...
//    Serial.println(gps_lng,7);
    if (gps_lat != 0 && gps_lng != 0) {     // if we get valid GPS data, get ready to send data packet via BT
      ...
      String Data_Packet = "FFFFHR" + String(HR_Val) + "AX" + String(0) + "AY" + String(0) + "AZ" + String(0) + "GX" + String(0) + "GY" + String(0) + "GZ" + String(0) + "LA" + String(gps_lat,7) + "LO" + String(gps_lng,7) + "DDDD";
